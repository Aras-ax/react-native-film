      ...
      <ScrollView bounces={false} scrollEventThrottle={1}>
        {this.state.ready ? (
          ...
          <View style={{backgroundColor: '#F4F9F5'}}>
            ...
            <View style={{paddingRight: 10, paddingLeft: 10}}>
              <View
                ...
                <TouchableOpacity
                  ...
                  <Text style={{color: '#FF645A', fontSize: 14}}>在线购票</Text>
                </TouchableOpacity>
              </View>
            ...
            <View
              name="performer"
              style={{paddingRight: 10, paddingLeft: 10, paddingTop: 15}}>
              <View>
            ...
            <ScrollableTabView
              ...
              <View
                tabLabel="评论"
                style={{marginBottom: 50, paddingLeft: 15, paddingRight: 15}}>
                <View
                  style={{
                    flexDirection: 'row',
                    paddingTop: 20,
                      ...
                      <View style={{marginLeft: 10, flex: 1}}>
                        <View style={{flexDirection: 'row'}}>
                          ...
                          <View style={{marginTop: 8, marginLeft: 4}}>
                            <Star
                              value={v.rating.value + '0'}
                              width={10}
                              height={10}
                            />
                          </View>
                        </View>
                        <Text style={{marginBottom: 8, color: '#3B3B3B'}}>
                          {v.content}
                        </Text>
                        <Text style={styles.smallFont}>4天前</Text>
                      </View>
...
export default function(props) {
  ...
  return <Detail {...props} route={route}></Detail>;
}
